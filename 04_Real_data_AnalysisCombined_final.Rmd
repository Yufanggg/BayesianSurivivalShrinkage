...
plot(PL_beta_overlap, PL_Simple_beta,
     col = "blue", pch = 16,
     xlab = "beta (ComplexData)", ylab = "beta (SimpleData)",
     main = "")
...
par(mfrow = c(1, 2))
plot(time_points, baseline_bSpline_complex, type = "l", main = "Complex B-spline", col = "red",  xlab = "Event Times (days)", ylab = "estimated baseline hazard")
plot(time_points[1:200], baseline_bSpline_complex[1:200], type = "l", main = "Complex B-spline", col = "red",  xlab = "Event Times (days)", ylab = "estimated baseline hazard")
```
