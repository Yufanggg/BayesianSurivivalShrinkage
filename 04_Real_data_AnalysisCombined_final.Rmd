...
save.image(file = "./Data/04_OverallKidneyData_Final1.RData")
```

#Visualize the result
```{r, echo=TRUE}
load(file = "./Data/04_OverallKidneyData_Final1.RData")
...
```{r, echo=TRUE}
name_label_simple <- names(combined_Data_Simple_int)[1:45]

par(mfrow = c(1, 2), mar = c(0, 0, 0, 0), oma = c(3, 24, 3, 1))
# Set up the plot without drawing points initially
plot(
  bSplines_model_Simple_beta, 1:45, type = "n",
  col = "blue", pch = 16,
  xlab = "Estimated Beta", ylab = "",
  main = "", yaxt = "n"
)
...
# Add beta coefficient points
points(bSplines_model_Simple_beta, 1:45, col = "blue", pch = 16)

# Add error bars for beta coefficients
segments(
  bSplines_model_Simple_coefLB, 1:45,
  bSplines_model_Simple_coefUB, 1:45,
  col = "blue"
)
...
# Add vertical y-axis labels
axis(2, at = 1:45, labels = name_label_simple, las = 2, cex.axis = 1.0)
title(main = "Beta Estimation (BayesbSplines) for simpleData")

plot(
  bSplines_model_noshrinkage_Simple_beta, 1:45, type = "n",
  col = "darkgreen", pch = 16,
  xlab = "Estimated Beta", ylab = "",
  main = "", yaxt = "n"
)
...
# Add beta coefficient points
points(bSplines_model_noshrinkage_Simple_beta, 1:45, col = "darkgreen", pch = 16)

# Add error bars for beta coefficients
segments(
  bSplines_model_noshrinkage_Simple_coefLB, 1:45,
  bSplines_model_noshrinkage_Simple_coefUB, 1:45,
  col = "darkgreen"
)
...
# Add beta coefficient points
points(PL_Simple_beta, 1:45, col = "blue", pch = 16)

# Add error bars for beta coefficients
segments(
  PL_Simple_coefLB, 1:45,
  PL_Simple_coefUB, 1:45,
  col = "blue"
)
...
plot(
  PL_Simple_noshrinkage_beta, 1:45, type = "n",
  col = "darkgreen", pch = 16,
  xlab = "Estimated Beta", ylab = "",
  main = "", yaxt = "n"
)
...
# Add beta coefficient points
points(PL_Simple_noshrinkage_beta, 1:45, col = "darkgreen", pch = 16)

# Add error bars for beta coefficients
segments(
  PL_Simple_noshrinkage_coefLB, 1:45,
  PL_Simple_noshrinkage_coefUB, 1:45,
  col = "darkgreen"
)
