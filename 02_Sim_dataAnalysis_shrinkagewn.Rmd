...
save.image(file = "./Data/sim_50_para_shrinkagenowith_PH_tiedTimes.RData")
```

```{r, echo=TRUE}
load(file = "./Data/sim_50_para_shrinkagenowith_PH_tiedTimes.RData")
...
FNR_PH_withShrinkage = rep(NA, replicate_times)
FNR_PH_noShrinkag = rep(NA, replicate_times)
...
for (i in 1:replicate_times){
  ...
  FNR_PH_withShrinkage[i] = sum(!Selection_PH_withShrinkage & variableSelection_reference)/sum(variableSelection_reference)
  FNR_PH_noShrinkag[i] = sum(!Selection_PH_noShrinkage & variableSelection_reference)/sum(variableSelection_reference)
...
Variance_PH_withShrinkage = apply(Beta_est_PH_withShrinkage, 2, var)
Variance_PH_noShrinkag = apply(Beta_est_PH_noShrinkag, 2, var)
...
rMSEs_PH_withShrinkage <- sqrt(apply(MSEs_PH_withShrinkage_, 2, mean))
rMSEs_PH_noShrinkag <- sqrt(apply(MSEs_PH_noShrinkag_, 2, mean))
...
lines(Bias_PH_withShrinkage, type = "o", col = "green", pch = 16)
...
lines(Variance_PH_withShrinkage, type = "o", col = "green", pch = 16)
...
# Subfigure 3: MSE
plot(rMSEs_bSplines_withShrinkag, type = "o", col = "blue", xlab = "estimated Betas", ylab = "MSE", ylim = c(0, 0.5), main = "rMSE for Beta estimation", pch = 16)
...
lines(rMSEs_PH_withShrinkage, type = "o", col = "green", pch = 16)
lines(rMSEs_bSplines_noShrinkag, type = "o", col = "orange", pch = 16)
lines(rMSEs_PH_noShrinkag, type = "o", col = "purple", pch = 16)
...
boxplot(FDR_list, names = c("bSplines_withShrinkag", "PL_withShrinkage", "bSplines_noShrinkag", "PL_noShrinkag"), col = c("blue", "green", "orange", "purple"), main = "FDR Boxplots", xlab = "", ylab = "FDR")

# Subfigure 5 Type II error
Power_list = list(bSplines_withShrinkag = 1 - FNR_bSplines_withShrinkag, bSplines_noShrinkag = 1 - FNR_bSplines_noShrinkag,  PL_withShrinkage = 1 - FNR_PH_withShrinkage, PL_noShrinkag = 1 - FNR_PH_noShrinkag)
boxplot(Power_list, names = c("bSplines_withShrinkag", "PL_withShrinkage", "bSplines_noShrinkag", "PL_noShrinkag"), col = c("blue", "green", "orange", "grey"), main = "Power", xlab = "", ylab = "Power")
...
boxplot(C_index_list, names = c("bSplines_withShrinkag", "PL_withShrinkage", "bSplines_noShrinkag", "PL_noShrinkag"), col = c("blue", "green", "orange", "purple"), main = "C index", xlab = "", ylab = "C index")
```
