...
cor_sp_bSplines_withShrinkage = rep(NA, replicate_times)
...
cor_sp_bSplines_noShrinkag = rep(NA, replicate_times)
...
for (i in 1:replicate_times){
  ...
  cor_sp_bSplines_withShrinkage[i] <- cor(sp_true, sp_pre_bSplines_withShrinkage)
  cor_sp_bSplines_noShrinkag[i] <- cor(sp_true, sp_pre_bSplines_noShrinkage)
...
cor_eta_list = list(withShrinkage = cor_eta_bSplines_withShrinkage, noShrinkag = cor_eta_bSplines_noShrinkag)
boxplot(cor_eta_list, names = c("withShrinkage", "noShrinkag"), col = c("blue", "green"), main = "True vs. predicted linear predictor", xlab = "", ylab = "correlation")
...
boxplot(CI_index_list, names = c("withshrinkage", "noshrinkage"), col = c("blue", "green"), main = "C index Boxplots", xlab = "", ylab = "CI index")
```
