...
for (i in 1:replicate_times){
  ...
  CI_index_bSplines_withShrinkage[i] <- rcorr.cens(-sp_pre_bSplines_noShrinkage, Surv(time, true_status))# rcorr.cens
  CI_index_bSplines_noShrinkag[i] <- rcorr.cens(-sp_pre_bSplines_withShrinkage, Surv(time, true_status))
