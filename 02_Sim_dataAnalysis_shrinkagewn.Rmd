...
for (i in 1:replicate_times){
  ...
  CI_index_bSplines_withShrinkage[i] <- rcorr.cens(1-sp_pre_bSplines_withShrinkage, Surv(time, true_status))[["C Index"]] # rcorr.cens
  CI_index_bSplines_noShrinkag[i] <- rcorr.cens(1-sp_pre_bSplines_noShrinkage, Surv(time, true_status))[["C Index"]] 
