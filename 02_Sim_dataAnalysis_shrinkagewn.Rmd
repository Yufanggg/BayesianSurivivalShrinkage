...
plot(Variance_bSplines_withShrinkag, type = "o", col = "blue", xlab = "estimated Betas", ylab = "Variance", ylim = c(0, 0.1), main = "Variance for Beta estimation", pch = 16)
...
# Subfigure 3: MSE
plot(rMSEs_bSplines_withShrinkag, type = "o", col = "blue", xlab = "estimated Betas", ylab = "MSE", ylim = c(0, 0.1), main = "rMSE for Beta estimation", pch = 16)
