...
for (i in 1:replicate_times){
  ...
  Brier_score_bSplines_withShrinkage[i] <- sum((true_status - sp_pre_bSplines_withShrinkage)**2)
  
  sp_pre_bSplines_noShrinkage <- simulated_results[,i]$sp_bSplines_noShrinkage
  Brier_score_bSplines_noShrinkag[i] <- sum((true_status - sp_pre_bSplines_noShrinkage)**2)
