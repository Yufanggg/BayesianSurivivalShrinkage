...
for (i in 1:replicate_times){
  ...
  CI_index_bSplines_withShrinkage[i] <- rcorr.cens(sp_pre_bSplines_withShrinkage, Surv(time, true_status))[["C Index"]] # rcorr.cens
  CI_index_bSplines_noShrinkag[i] <- rcorr.cens(sp_pre_bSplines_noShrinkage, Surv(time, true_status))[["C Index"]] 
...
# Add legend
legend("topright", legend = c("bSplinewithshrinkage", "bSplinenoshrinkage"), col = c("blue", "green"), pch = 16, lty = 1)
...
boxplot(FDR_list, names = c("bSplinewithshrinkage", "bSplinenoshrinkage"), col = c("blue", "green"), main = "FDR Boxplots", xlab = "", ylab = "FDR")
...
boxplot(Brier_score_list, names = c("Brier_score_bSplines_withshrinkage", "Brier_score_bSplines_noshrinkage"), col = c("blue", "green"), main = "Brier score Boxplots", xlab = "", ylab = "Brier score")
...
boxplot(CI_index_list, names = c("CI_index_bSplineswithshrinkage", "CI_index_bSplinesnoshrinkage"), col = c("blue", "green"), main = "CI index Boxplots", xlab = "", ylab = "CI index")
```
