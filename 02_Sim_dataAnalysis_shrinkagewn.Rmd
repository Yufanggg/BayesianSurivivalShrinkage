...
# Subfigure 3: MSE
plot(MSEs_bSplines_withShrinkag, type = "o", col = "blue", xlab = "estimated Betas", ylab = "MSE", ylim = c(0, 0.1), main = "MSE for Beta estimation", pch = 16)
...
lines(MSEs_PH_withShrinkage, type = "o", col = "green", pch = 16)
lines(MSEs_bSplines_noShrinkag, type = "o", col = "orange", pch = 16)
