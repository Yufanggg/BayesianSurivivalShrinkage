...
NumSelect_bSplines_withShrinkage = rep(NA, replicate_times)
...
NumSelect_bSplines_noShrinkag = rep(NA, replicate_times)
...
NumSelect_PH_withShrinkage = rep(NA, replicate_times)
...
NumSelect_PH_noShrinkage = rep(NA, replicate_times)
...
for (i in 1:replicate_times){
  ...
  # Number of selected
  NumvariableSelection = sum(variableSelection_reference)
  NumSelect_bSplines_withShrinkage[i] = sum(Selection_bSplines_withShrinkage)
  NumSelect_bSplines_noShrinkag[i] = sum(Selection_bSplines_noShrinkage)
  
  NumSelect_PH_withShrinkage[i] = sum(Selection_PH_withShrinkage)
  NumSelect_PH_noShrinkage[i] =  sum(Selection_PH_noShrinkage)
