...
plot_beta_estimates_scatter <- function(beta_list, labels, title, n_features, randomList) {
  ...
  for (i in randomList) {
    ...
    legend("topright", legend = paste("r =", round(r, 2)), bty = "n", text.col = "red")
  }
}

randomList <- sample(1:10, 4, replace = FALSE)

pdf("Estimated_Betas_bSpline.pdf", width = 12, height = 8)
...
# Cox regression
pdf("Estimated_Betas_CoxRegression.pdf", width = 12, height = 8)
par(mfrow = c(2, 4), mar = c(3, 3, 4, 1), oma = c(0, 0, 0, 0))
...
# Bayesian PL
pdf("Estimated_Betas_PL.pdf", width = 12, height = 8)
par(mfrow = c(2, 4), mar = c(3, 3, 4, 1), oma = c(0, 0, 0, 0))
