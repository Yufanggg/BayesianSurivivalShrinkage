...
for (i in seq_along(folds)) {
  ...
  bSplines_model_C_INDEX_Simple[i] <- rcorr.cens(-bSplines_model_Prediction_SurvivalProb_Simple, Surv(testing_dataset$obstime, testing_dataset$status))["C Index"] 
    ...
    coxRegression_C_INDEX_Simple[i] <- rcorr.cens(-coxRegression_SurvivalProb_Simple, Surv(testing_dataset$obstime, testing_dataset$status))["C Index"] 
    ...
    PL_C_INDEX_Simple[i] <- rcorr.cens(-PL_Prediction_SurvivalProb_Simple, Surv(testing_dataset$obstime, testing_dataset$status))["C Index"] 
}
