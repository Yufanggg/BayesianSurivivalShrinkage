...
for (i in 1:replicate_times){
  ...
  d_exponential[i] <- simulated_results[,i]$cvl_weibull - simulated_results[,i]$l_weibull
...
l_list = list(l_exponential = l_exponential, l_weibull = l_weibull, l_bSplines = l_bSplines)
boxplot(l_list, names = c("Exponential", "Weibull", "B-Splines"), col = c("blue", "green", "orange"), main = "cvl Boxplots", xlab = "", ylab = "l")


# Subfigure 6 Correlation for linear predictors
d_list = list(d_exponential = d_exponential, d_exponential = d_exponential, d_bSplines = d_bSplines)
boxplot(d_list, names = c("Exponential", "Weibull", "B-Splines"), col = c("blue", "green", "orange"), main = "d", xlab = "", ylab = "d")
```
