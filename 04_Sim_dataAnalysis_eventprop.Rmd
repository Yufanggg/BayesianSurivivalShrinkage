...
for (i in 1:replicate_times){
  ...
  Beta_est_PL_0.1[i, ] <-  simulated_results[,i]$Beta_PL_0.1
  Beta_est_PL_0.4[i, ] <-  simulated_results[,i]$Beta_PL_0.4
  Beta_est_PL_0.9[i, ] <-  simulated_results[,i]$Beta_PL_0.9
  ...
  MSEs_PL_0.1_[i, ] <- (simulated_results[,i]$Beta_PL_0.1 - Beta_true)**2
  MSEs_PL_0.4_[i, ] <- (simulated_results[,i]$Beta_PL_0.4 - Beta_true)**2
  MSEs_PL_0.9_[i, ] <- (simulated_results[,i]$Beta_PL_0.9 - Beta_true)**2
  ...
  Selection_PL_0.1 <- simulated_results[,i]$varSel_PL_0.1
  Selection_PL_0.4 <- simulated_results[,i]$varSel_PL_0.4
  Selection_PL_0.9 <- simulated_results[,i]$varSel_PL_0.9
...
# Subfigure 1: Bias
plot(Bias_bSplines_0.1, type = "o", col = "#641e16", xlab = "Betas", ylab = "Bias", main = "Bias for Beta estimation", pch = 16, ylim = c(0, 0.4))
...
plot(Variance_bSplines_0.1, type = "o", col = "#641e16", xlab = "Betas", ylab = "Variance", ylim = c(0, 0.8), main = "Variance for Beta estimation", pch = 16,  horiz = TRUE)
...
# Subfigure 3: MSE
plot(rMSEs_bSplines_0.1, type = "o", col = "#641e16", xlab = "Betas", ylab = "rMSE", ylim = c(0, 1.2), main = "rMSE for Beta estimation", pch = 16)
