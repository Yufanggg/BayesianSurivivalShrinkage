...
plot(Variance_bSplines_0.1, type = "o", col = "#641e16", xlab = "estimated Betas", ylab = "Variance", ylim = c(0, 0.6), main = "Variance for Beta estimation", pch = 16)
...
# Subfigure 3: MSE
plot(rMSEs_bSplines_0.1, type = "o", col = "#641e16", xlab = "estimated Betas", ylab = "rMSE", ylim = c(0, 0.8), main = "MSE for Beta estimation", pch = 16)
...
boxplot(Num_Selected_list, names = c("bSplines_0.1", "bSplines_0.4", "bSplines_0.9", "PH_0.1", "PH_0.4", "PH_0.9"), col = c("#641e16", "#c0392b", "#f2d7d5", "#145a32", "#229954", "#a2d9ce"), main = "Proportional of Selected variables", xlab = "", ylab = "Prop of Selected variables", ylim = c(0, 1))
```
