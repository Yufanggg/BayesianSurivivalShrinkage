...
simulation_bayint_survival <- function(
  ...
  for (event_prop in event_props) {
    ...
    output[[paste0("diagnostics_PL_", event_prop)]] <- summary(model_fit_PL)$summary[, c("Rhat", "n_eff")]
    ...
    if ("DesignCoefficients" %in% criteria) {
      ...
      output[[paste0("Beta_PL_", event_prop)]] <- result_PL$Beta_bayesian_est[, "mean"]
    }
    ...
    if ("variableSelection" %in% criteria) {
      ...
      output[[paste0("varSel_PL_", event_prop)]] <- result_PL$variableSelection
    }
    ...
    if ("Prediction_SurvivalProb" %in% criteria && withPrediction) {
      ...
      output[[paste0("eta_pred_PL_", event_prop)]] <- result_PL$eta_pred
    }
  }
  return(output)
}
...
diagnostics_PL_0.1 = matrix(154, replicate_times)
diagnostics_PL_0.4 = matrix(154, replicate_times)
diagnostics_PL_0.9 = matrix(154, replicate_times)
...
Beta_est_PL_0.1 = matrix(nrow = replicate_times, ncol = 55)
Beta_est_PL_0.4 = matrix(nrow = replicate_times, ncol = 55)
Beta_est_PL_0.9 = matrix(nrow = replicate_times, ncol = 55)
...
varSel_PL_0.1 = matrix(nrow = replicate_times, ncol = 55)
varSel_PL_0.4 =  matrix(nrow = replicate_times, ncol = 55)
varSel_PL_0.9 =  matrix(nrow = replicate_times, ncol = 55)

# Bias  
Bias_bSplines_0.1 = rep(NA, ncol = 55)
Bias_bSplines_0.4 = rep(NA, ncol = 55)
Bias_bSplines_0.9 = rep(NA, ncol = 55)
Bias_PL_0.1 = rep(NA, ncol = 55)
Bias_PL_0.4 = rep(NA, ncol = 55)
Bias_PL_0.9 = rep(NA, ncol = 55)
...
MSEs_PL_0.1_ = matrix(nrow = replicate_times, ncol = 55)
MSEs_PL_0.4_ = matrix(nrow = replicate_times, ncol = 55)
MSEs_PL_0.9_ = matrix(nrow = replicate_times, ncol = 55)

# Type I error
FDR_bSplines_0.1 = rep(NA, replicate_times)
FDR_bSplines_0.4 = rep(NA, replicate_times)
FDR_bSplines_0.9 = rep(NA, replicate_times)
FDR_PL_0.1 = rep(NA, replicate_times)
FDR_PL_0.4 = rep(NA, replicate_times)
FDR_PL_0.9 = rep(NA, replicate_times)

# Type II error
FNR_bSplines_0.1 = rep(NA, replicate_times)
FNR_bSplines_0.4 = rep(NA, replicate_times)
FNR_bSplines_0.9 = rep(NA, replicate_times)
FNR_PL_0.1 = rep(NA, replicate_times)
FNR_PL_0.4 = rep(NA, replicate_times)
FNR_PL_0.9 = rep(NA, replicate_times)
...
for (i in 1:replicate_times){
  ...
  Beta_est_PL_0.1[i, ] <-  simulated_results[,i]$Beta_PH_0.1
  Beta_est_PL_0.4[i, ] <-  simulated_results[,i]$Beta_PH_0.4
  Beta_est_PL_0.9[i, ] <-  simulated_results[,i]$Beta_PH_0.9
  ...
  MSEs_PL_0.1_[i, ] <- (simulated_results[,i]$Beta_PH_0.1 - Beta_true)**2
  MSEs_PL_0.4_[i, ] <- (simulated_results[,i]$Beta_PH_0.4 - Beta_true)**2
  MSEs_PL_0.9_[i, ] <- (simulated_results[,i]$Beta_PH_0.9 - Beta_true)**2
  ...
  Selection_PL_0.1 <- simulated_results[,i]$varSel_PH_0.1
  Selection_PL_0.4 <- simulated_results[,i]$varSel_PH_0.4
  Selection_PL_0.9 <- simulated_results[,i]$varSel_PH_0.9
  ...
  FDR_PL_0.1[i] <- sum(Selection_PL_0.1 & !variableSelection_reference) / sum(Selection_PL_0.1)
  FDR_PL_0.4[i] <- sum(Selection_PL_0.4 & !variableSelection_reference) / sum(Selection_PL_0.4)
  FDR_PL_0.9[i] <- sum(Selection_PL_0.9 & !variableSelection_reference) / sum(Selection_PL_0.9)
  ...
  FNR_PL_0.1[i] = sum(!Selection_PL_0.1 & variableSelection_reference)/sum(variableSelection_reference)
  FNR_PL_0.4[i] = sum(!Selection_PL_0.4 & variableSelection_reference)/sum(variableSelection_reference)
  FNR_PL_0.9[i] = sum(!Selection_PL_0.9 & variableSelection_reference)/sum(variableSelection_reference)
}
...
Bias_PL_0.1 = apply(Beta_est_PL_0.1, 2, mean) - Beta_true
Bias_PL_0.4 = apply(Beta_est_PL_0.4, 2, mean) - Beta_true
Bias_PL_0.9 = apply(Beta_est_PL_0.9, 2, mean) - Beta_true
...
Variance_PL_0.1 = apply(Beta_est_PL_0.1, 2, var)
Variance_PL_0.4 = apply(Beta_est_PL_0.4, 2, var)
Variance_PL_0.9 = apply(Beta_est_PL_0.9, 2, var)
...
rMSEs_PL_0.1 <- sqrt(apply(MSEs_PL_0.1_, 2, mean))
rMSEs_PL_0.4 <- sqrt(apply(MSEs_PL_0.4_, 2, mean))
rMSEs_PL_0.9 <- sqrt(apply(MSEs_PL_0.9_, 2, mean))
...
# Subfigure 1: Bias
plot(Bias_bSplines_0.1, type = "o", col = "#641e16", xlab = "Betas", ylab = "Bias", main = "Bias for Beta estimation", pch = 16, ylim = c(-0.35, 0.35))
...
lines(Bias_PL_0.1, type = "o", col = "#145a32", pch = 16)
lines(Bias_PL_0.4, type = "o", col = "#229954", pch = 16)
lines(Bias_PL_0.9, type = "o", col = "#a2d9ce", pch = 16)


abline(v = 10, col = "red", lty = 2)
legend("top", legend = c("bSplines_0.1", "bSplines_0.4", "bSplines_0.9", "PL_0.1", "PL_0.4", "PL_0.9"), col = c("#641e16", "#c0392b", "#f2d7d5", "#145a32", "#229954", "#a2d9ce"), pch = 16, lty = 1,  horiz = TRUE) # Add legend

# Subfigure 2: Variance
plot(Variance_bSplines_0.1, type = "o", col = "#641e16", xlab = "Betas", ylab = "Variance", ylim = c(0, 0.65), main = "Variance for Beta estimation", pch = 16,  horiz = TRUE)
...
lines(Variance_PL_0.1, type = "o", col = "#145a32", pch = 16)
lines(Variance_PL_0.4, type = "o", col = "#229954", pch = 16)
lines(Variance_PL_0.9, type = "o", col = "#a2d9ce", pch = 16)
...
# Subfigure 3: MSE
plot(rMSEs_bSplines_0.1, type = "o", col = "#641e16", xlab = "Betas", ylab = "rMSE", ylim = c(0, 0.9), main = "rMSE for Beta estimation", pch = 16)
...
lines(rMSEs_PL_0.1, type = "o", col = "#145a32", pch = 16)
lines(rMSEs_PL_0.4, type = "o", col = "#229954", pch = 16)
lines(rMSEs_PL_0.9, type = "o", col = "#a2d9ce", pch = 16)
...
FDR_list = list(bSplines_0.1 = FDR_bSplines_0.1, bSplines_0.4 = FDR_bSplines_0.4, bSplines_0.9 = FDR_bSplines_0.9, PL_0.1 = FDR_PL_0.1, PL_0.4 = FDR_PL_0.4, PL_0.9 = FDR_PL_0.9)
boxplot(FDR_list, names = c("bSplines_0.1", "bSplines_0.4", "bSplines_0.9", "PL_0.1", "PL_0.4", "PL_0.9"), col = c("#641e16", "#c0392b", "#f2d7d5", "#145a32", "#229954", "#a2d9ce"), main = "FDR Boxplots", xlab = "", ylab = "FDR")
...
Power_list = list(bSplines_0.1 = 1 - FNR_bSplines_0.1, bSplines_0.4 = 1 - FNR_bSplines_0.4, bSplines_0.9 = FNR_bSplines_0.9, 
                         PL_0.1 = 1 - FNR_PL_0.1, PL_0.4 = 1 - FNR_PL_0.4, PL_0.9 = FNR_PL_0.9)
boxplot(Power_list, names = c("bSplines_0.1", "bSplines_0.4", "bSplines_0.9", "PL_0.1", "PL_0.4", "PL_0.9"), col = c("#641e16", "#c0392b", "#f2d7d5", "#145a32", "#229954", "#a2d9ce"), main = "Power", xlab = "", ylab = "Power", ylim = c(0, 1))
```
