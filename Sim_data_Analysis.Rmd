...
required_packages <- c("rstan", "MASS", "rstantools", "coda", "readr", "survival", "splines2", "dplyr", "simsurv", "Hmisc", "caret", "parallel")
...
CI_index_exponential = matrix(nrow = replicate_times, ncol = 55)
CI_index_weibull = matrix(nrow = replicate_times, ncol = 55)
CI_index_bSplines = matrix(nrow = replicate_times, ncol = 55)


Brier_score_exponential = matrix(nrow = replicate_times, ncol = 55)
Brier_score_weibull = matrix(nrow = replicate_times, ncol = 55)
Brier_score_bSplines = matrix(nrow = replicate_times, ncol = 55)
