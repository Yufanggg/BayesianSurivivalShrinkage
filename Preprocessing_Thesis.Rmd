...
setwd("C:/Users/Alisa_Wang/Desktop/MasterThesis/Code/") #G:/MasterThesis/Code/   C:/Users/Alisa_Wang/Desktop/MasterThesis/Code/
```
...
imputed_df_using <- mice(df_using, method = methods, m = 1, maxit = 20, seed = 500, ridge = 0.001, MaxNWts = 20000)
...
imputed_df_using_2 <- mice(df_using, method = methods, m = 1, maxit = 20, seed = 600, ridge = 0.001, MaxNWts = 20000)

# Complete the dataset with the imputed values
completed_df_2 <- complete(imputed_df_using_2)
print(completed_df_2)
saveRDS(completed_df_2, "./Data/imputed_NOTR_DGF_2.rds")
sum(complete.cases(completed_df_2))
```
