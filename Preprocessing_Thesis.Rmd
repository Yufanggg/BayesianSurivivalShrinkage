...
df_using <- subset(df_using, select = -c(Typeofdonor, Lowestcreatinine¦Ìmoll, RecipientfullmatchHLAstring, Donorcauseofdeath, Donorweight, Donorheight, Recipient_weight, Recipient_height))
```
...
imputed_df_using <- mice(df_using, method = methods, m = 1, maxit = 5, seed = 500, ridge = 0.001)
