...
cvl_bSplines_model_noInt <- cross_validated_log_likelihood (bSplines_model_noInt, nrow(strafied_Data_DBD))
l_bSplines_model_noInt <- max_log_likelihood(bSplines_model_noInt, nrow(strafied_Data_DBD))
...
cvl_bSplines_model_withInt <- cross_validated_log_likelihood (bSplines_model_withInt, nrow(strafied_Data_DBD))
l_bSplines_model_withInt <- max_log_likelihood (bSplines_model_withInt, nrow(strafied_Data_DBD))

output_DBD <- c(cvl_bSplines_model_noInt, cvl_bSplines_model_withInt)
names(output_DBD) <- ("bSplines_noInt, bSplines_withInt")
output_DBD
save.image(file = "./Data/real_test.RData")
```
