...
axis(1, at = 1:91, labels = c(names(strafied_Data_DBD_int_noise)[1:91], "noise1", "noise2"), las = 2, cex.axis = 0.7)
...
PL_model_Int_full_coef <- PL_model_Int_results_full$Beta_bayesian_est[, "mean"]
PL_model_Int_full_varSel <- PL_model_Int_full$variableSelection


# Visualize the model results
par(mfrow = c(2, 2))
plot(bSplines_model_Int_results_15_coef, type = "o", col = "blue", xlab = "", ylab = "Beta", main = "Beta estimation", pch = 16, ylim = c(-10, 10), xaxt = "n")
# Add background rectangles
...
plot(bSplines_model_Int_results_11_coef, type = "o", col = "blue", xlab = "", ylab = "Beta", main = "", pch = 16, ylim = c(-1, 1), xaxt = "n")
# Add background rectangles
...
lines(bSplines_model_Int_results_11_coef, type = "o", col = "darkgreen", pch = 16)
abline(a = 0, b =0, col = "red")


plot(bSplines_model_Int_results_7_coef, type = "o", col = "blue", xlab = "", ylab = "Beta", main = "", pch = 16, ylim = c(-1, 1), xaxt = "n")
# Add background rectangles
...
lines(bSplines_model_Int_results_7_coef, type = "o", col = "darkgreen", pch = 16)
abline(a = 0, b =0, col = "red")
...
plot(PL_model_Int_full_coef, type = "o", col = "blue", xlab = "", ylab = "Beta", main = "", pch = 16, ylim = c(-1, 1), xaxt = "n")
# Add background rectangles
