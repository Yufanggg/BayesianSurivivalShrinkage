...
```{r, echo = TRUE}
# Step 1: simplified model results
...
bSplines_model_Int_results = Bayesian_Survival_result_Extract(bayesian_model_fit = bSplines_model_Int, model_type = "bSplines", criteria = c("DesignCoefficients", "variableSelection"))
...
PL_model_Int_results = Bayesian_Survival_result_Extract(bayesian_model_fit = ph_model_Int, model_type = "none", criteria = c("DesignCoefficients", "variableSelection"))
