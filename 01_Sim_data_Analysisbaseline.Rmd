...
boxplot(Num_Selected_list, names = c("Exponential", "Weibull", "B-Splines", "ParticalLiklihood"), col = c("blue", "green", "orange", "purple"), main = "Proportional of Selected variables", xlab = "", ylab = "Selected variables", ylim = c(0, 1))
