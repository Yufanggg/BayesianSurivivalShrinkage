...
# Variance
Variance_exponential_ = matrix(nrow = replicate_times, ncol = 55)
Variance_weibull_ = matrix(nrow = replicate_times, ncol = 55)
Variance_bSplines_ = matrix(nrow = replicate_times, ncol = 55)
Variance_PH_ = matrix(nrow = replicate_times, ncol = 55)
...
# Type II error
Num_Selected_exponential = rep(NA, replicate_times)
Num_Selected_weibull = rep(NA, replicate_times)
Num_Selected_bSplines = rep(NA, replicate_times)
Num_Selected_PH = rep(NA, replicate_times)
...
for (i in 1:replicate_times){
  ...
  # Variance
  Variance_exponential_[i, ] = simulated_results[,i]$Beta_est_exponential - Beta_true
  Variance_weibull_[i, ] = simulated_results[,i]$Beta_est_weibull - Beta_true
  Variance_bSplines_[i, ] = simulated_results[,i]$Beta_est_bSplines - Beta_true
  Variance_PH_ = simulated_results[,i]$Beta_est_PH - Beta_true
  
  # MSE
  MSEs_exponential_[i, ] <- (Beta_est_exponential - Beta_true)**2
  MSEs_weibull_[i, ] <- (Beta_est_weibull - Beta_true)**2
  MSEs_bSplines_[i, ] <- (Beta_est_bSplines - Beta_true)**2
  MSEs_PH_[i, ] <- (Beta_est_PH - Beta_true)**2
  ...
  Num_Selected_exponential[i] = sum(Selection_exponential)
  Num_Selected_weibull[i] = sum(Selection_weibull)
  Num_Selected_bSplines[i] = sum(Selection_bSplines)
  Num_Selected_PH[i] = sum(Selection_PH)
...
# Variance 
Variance_exponential = apply(Variance_exponential_, 2, var)
Variance_weibull = apply(Variance_weibull_, 2, var)
Variance_bSplines = apply(Variance_bSplines_, 2, var)
Variance_PH = apply(Variance_PH_, 2, var)


# MSE
MSEs_exponential <- apply(MSEs_exponential_, 2, mean)
MSEs_weibull <- apply(MSEs_weibull_, 2, mean)
MSEs_bSplines <- apply(MSEs_bSplines_, 2, mean)
MSEs_PH <- apply(MSEs_PH_, 2, mean)
...
# Subfigure 1: Bias
plot(Bias_exponential, type = "o", col = "blue", xlab = "estimated Betas", ylab = "Bias", ylim = c(0, 0.3), main = "Bias for Beta estimation", pch = 16)
...
lines(Bias_PH, type = "o", col = "grey", pch = 16)

abline(v = 10, col = "red", lty = 2)
legend("topright", legend = c("Exponential", "Weibull", "B-Splines", "ParticalLiklihood"), col = c("blue", "green", "orange", "grey"), pch = 16, lty = 1) # Add legend

# Subfigure 2: Variance
plot(Variance_exponential, type = "o", col = "blue", xlab = "estimated Betas", ylab = "Variance", ylim = c(0, 0.3), main = "Variance for Beta estimation", pch = 16)
...
lines(Variance_PH, type = "o", col = "grey", pch = 16)
...
# Subfigure 3: MSE
plot(MSEs_exponential, type = "o", col = "blue", xlab = "estimated Betas", ylab = "MSE", ylim = c(0, 0.3), main = "MSE for Beta estimation", pch = 16)
...
lines(MSEs_weibull, type = "o", col = "green", pch = 16)
lines(MSEs_bSplines, type = "o", col = "orange", pch = 16)
lines(MSEs_exponential, type = "o", col = "blue", pch = 16)
lines(MSEs_PH, type = "o", col = "grey", pch = 16)
...
boxplot(FDR_list, names = c("Exponential", "Weibull", "B-Splines", "ParticalLiklihood"), col = c("blue", "green", "orange", "grey"), main = "FDR Boxplots", xlab = "", ylab = "FDR")

# Subfigure 5 Type II error
Num_Selected_list = list(Exponential = Num_Selected_exponential, Weibull = Num_Selected_weibull, BSplines = Num_Selected_bSplines, ParticalLiklihood = Num_Selected_PH)
boxplot(Num_Selected_list, names = c("Exponential", "Weibull", "B-Splines", "ParticalLiklihood"), col = c("blue", "green", "orange", "grey"), main = "FDR Boxplots", xlab = "", ylab = "FDR")
...
boxplot(cor_list, names = c("Exponential", "Weibull", "B-Splines", "ParticalLiklihood"), col = c("blue", "green", "orange", "grey"), main = "True vs. predicted linear predictor", xlab = "", ylab = "correlation")
...
boxplot(CI_index_list, names = c("Exponential", "Weibull", "B-Splines", "ParticalLiklihood"), col = c("blue", "green", "orange", "grey"), main = "C index Boxplots", xlab = "", ylab = "C index")
```
