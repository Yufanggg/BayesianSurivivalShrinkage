...
# Variance
Variance_exponential = matrix(nrow = replicate_times, ncol = 55)
Variance_weibull = matrix(nrow = replicate_times, ncol = 55)
Variance_bSplines = matrix(nrow = replicate_times, ncol = 55)
Variance_PH = matrix(nrow = replicate_times, ncol = 55)
