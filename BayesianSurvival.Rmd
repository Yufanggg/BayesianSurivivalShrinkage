...
"
      ...
      functions {
        ...
        vector vectorized_logh_0i(vector u_vec, vector T, matrix bSpline_basis, vector coefficients, vector sigma){
           ...
           vector[num_elements(T)] logh_0t = bSpline_basis * coefficients + sigma;
     ...
     int find_index(real u, vector t) {
      ...
      // log-likelihood, represented by [target]
      for (Ti in uniqueT){
        real H_0i_ = gauss_kronrod_quad_Hazard_basline(locat, weights, Ti, uniqueT, bSpline_basis, coefficients, sigma);
        real logh_0i_ = logh_0i(Ti, uniqueT, bSpline_basis, coefficients, sigma);
