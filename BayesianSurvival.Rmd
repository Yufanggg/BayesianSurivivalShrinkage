...
Bayesian_Survival_includingbaseline <- function(stan_data_basline, assumption = "exponential", school = "Bayesian", 
                              niter = 10000, 
                              nwarmup = 1000,
                              thin = 10,
                              chains = 1) {
...
"
    ...
    generated quantities{ // predicting the survival time on the new/test dataset
      ...
      for (m in 1:M){
        ...
        survival_prob[m,] = exp(-H_0i_ + x_new*Beta) //vectorize over the x_new.
      }
    }
    "
    }
...
Output3 <- Bayesian_Survival_includingbaseline(stan_data = stan_data_basline, assumption = "bSplines") #exponential, weibull,  bSplines
print(Output3)
```
